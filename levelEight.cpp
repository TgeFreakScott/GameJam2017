...
levelEight::levelEight(levels & levels, sf::Font font, sf::Texture texture) :
	m_levels(&levels),
	m_comicSans(font),
	m_texture(texture),
	m_textmessage("Press H", m_comicSans, 30)
{
...
void levelEight::update(sf::Time deltaTime)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::H))
	{
		...
		{
			m_levels->setGameState(GameState::levelNine);
		}
	}
}

void levelEight::render(sf::RenderWindow & window)
{
