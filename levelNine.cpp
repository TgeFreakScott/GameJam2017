...
levelNine::levelNine(levels & levels, sf::Font font, sf::Texture texture) :
	m_levels(&levels),
	m_comicSans(font),
	m_texture(texture),
	m_textmessage("Press J", m_comicSans, 30)
{
...
void levelNine::update(sf::Time deltaTime)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::J))
	{
		...
		{
			m_levels->setGameState(GameState::levelTen);
		}
	}
}

void levelNine::render(sf::RenderWindow & window)
{
