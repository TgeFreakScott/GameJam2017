...
levelTwo::levelTwo(levels & levels, sf::Font font, sf::Texture texture) :
	m_levels(&levels),
	m_comicSans(font),
	m_texture(texture),
	m_textmessage("Press Enter", m_comicSans, 30)
{
	...
	m_colourC.setPosition(sf::Vector2f(100, 500));
...
void levelTwo::update(sf::Time deltaTime)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Return))
	{
		...
		{
			m_levels->setGameState(GameState::levelThree);
		}
	}
}
